...
%---------------------------------------------------------
  \cventry
    ...
    {Mar. 2021 - Present} % Date(s)
    {
      ...
      \item {
        Lead modeling of COVID-19 vaccine adoption rates in vulnerable
        populations around the greater Boston area to give targeted, actionable
        outreach recommendations, resulting in 400+ additional vaccine
        sign-ups.
      }
      \end{cvitems}
    }
